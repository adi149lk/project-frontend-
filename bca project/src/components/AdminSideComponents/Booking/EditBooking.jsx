...
function EditBooking() {
  ...
  const getBookingById = (bookingId) => {
    let config = {
      ...
      url: `${process.env.REACT_APP_API_URL}/booking/get-booking-by-id/${bookingId}`,
      headers: {},
    };
    ...
    axios
      .request(config)
      .then((response) => {
        console.log("Response of getBookingById: ", response.data);
        reset({
  ...
  const onSubmit = (data) => {
    ...
    let config = {
      method: "patch",
      maxBodyLength: Infinity,
      url: `${process.env.REACT_APP_API_URL}/booking/update-booking/${id}`,
      headers: {
